...
public class PlanListActivityBAK extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		.setPositiveButton("确定", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				Toast.makeText(PlanListActivityBAK.this, "开始下载新版本!", 0)
						.show();
//				downloadAd.dismiss();
	...
	private void initPlanView() {
		...
		back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				PlanListActivityBAK.this.finish();
			}
		});
	...
	private class EnquireAppVersionAsyncTask extends
		...
		protected String doInBackground(String... params) {
			return new HttpClientUtil(PlanListActivityBAK.this).lastAppVersion(
					PlanListActivityBAK.this, "itasset_mcheck");
		}
		...
		protected void onPostExecute(String result) {
			...
			if ("0".equals(result)) {
				Toast.makeText(PlanListActivityBAK.this, "获取版本号失败!", 0).show();
			} else {
				// Log.i("a", "版本 = " + result);
				...
				try {
					...
					result = result.replaceAll("\"","");
					 Toast.makeText(PlanListActivityBAK.this, "当前应用版本号 : " +
	...
	public void Beginning() {
		...
		new Thread() {
			public void run() {
				...
				if (ipStr.equals("")) {
					ipStr = new AppSharedPreferences(PlanListActivityBAK.this, "gdht")
							.getIP();
				}
		...
		public void handleMessage(Message msg) {// 定义一个Handler，用于处理下载线程与UI间通讯
			if (!Thread.currentThread().isInterrupted()) {
				...
				case -1:
					...
					loading_process = 1;
					Toast.makeText(PlanListActivityBAK.this, " " + loading_process, 1)
							.show();
					break;
				}
			}
