...
public class ScanActivityBak extends Activity {
...
//		}
		...
		} else
		{
			switch (App.getRfid().getInterrogatorModel())
			{
				...
				{
					AppSharedPreferences asp = new AppSharedPreferences(ScanActivityBak.this, "gdht");
					App.getRfid().setPower(asp.getGongLv());
					Toast.makeText(ScanActivityBak.this, "当前功率是  = " + App.getRfid().getPower(), 0).show();
					findViews();
					setOnClicks();
					break;
				}
...
//						rfidsdbService.saveRFID(s);
					...
					pd.dismiss();
					Intent intent = new Intent();
					intent.setClass(ScanActivityBak.this, ScanComplateActivity.class);
					intent.putStringArrayListExtra("rfidArray", rfidArray);
					intent.putExtra("assetInfoList", planAssetArrayList);
					ScanActivityBak.this.startActivity(intent);
				}
	...
	private void findViews() {
		...
		scanListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				Intent intent = new Intent(ScanActivityBak.this, RfidCheckActivity.class);
