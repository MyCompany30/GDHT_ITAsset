			...
			public void onClick(View v) {
				new AsyncTask<Void, Void, Void>(){
					...
					protected Void doInBackground(Void... params) {
						...
						new HttpClientUtil(YiPanActivity.this).checkAssetByCodes(YiPanActivity.this, PlanActivity.PLAN_ID, R.string.url_checkAssetByRfid, "Rfid", rfid, dataArray);
						return null;
					}
					protected void onPostExecute(Void result) {
						if(dataArray.size()>0){
							...
							intent.setClass(YiPanActivity.this, GuZhangDengJiActivity.class);
					...
					if(itemLayout.isChecked()){
						...
						new AsyncTask<Void, Void, String>(){
							...
							protected String doInBackground(Void... params) {
								return new HttpClientUtil(YiPanActivity.this).updateAssetStatus(YiPanActivity.this, PlanActivity.PLAN_ID, itemArray.get(position).getAssetInfoId(), "", "0", PlanActivity.operator);
